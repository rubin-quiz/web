...
const quizData = [
    {
        question: "フィンランド語で「大きな耳」という意味がある、サンタクロースが住んでいるとされるフィンランドの山は何でしょう？",
        answer: "コルヴァトゥントゥリ",
        categories: ["社会", ],
    },
    {
        question: "国旗の中央には国鳥のホオジロカンムリヅルが描かれている、東アフリカに位置する国はどこでしょう？",
        answer: "ウガンダ",
        categories: ["社会", ],
        supplement: "国旗のホオジロカンムリヅルは右足を上げた姿で描かれていますが、これは国が常に前進していることを表すとされています。"
    },
    {
        question: "炭に火をおこすうまい方法のことを、「冬」と「夏」という漢字を用いた四字熟語で何というでしょう？",
        answer: "夏下冬上",
        categories: ["ことば", ],
        supplement: "種火は夏には炭の下に、冬には上に置くとよいという意味です。"
    },
    {
        question: "「北海道フロンティアリーグ」や「九州アジアリーグ」などがこれにあたる、日本野球機構とは別に設立・運営されているプロ野球リーグを何というでしょう？",
        answer: "独立リーグ",
        categories: ["スポーツ", ],
    },
    {
        question: "ゲーム『スプラトゥーン』シリーズに登場する、人の姿に変身できる不思議なイカの種族は何でしょう？",
        answer: "インクリング",
        categories: ["サブカルチャー", ],
        supplement:"英語表記は inkling。ink（インク）に接尾辞 -ling（～の種族）を付けた造語になっているようです。"
    },
    {
        question: "2025年4月、自身初となるYoutube Liveで、ソロデビュー50周年を記念した東京ドーム公演と6年ぶりとなるアルバムの発売を発表した、代表曲に『止まらないha~ha』『時間よ止まれ』などがある日本のロックシンガーは誰でしょう？",
        answer: "矢沢永吉",
        categories: ["芸能", ],
    },
    {
        question: "「マッサマンカレー」や「シュクメルリ鍋定食」など、世界の伝統料理を期間限定で販売している、看板メニューの「牛めし」でも有名な飲食チェーンはどこでしょう？",
        answer: "松屋",
        categories: ["グルメ", ],
    },
    {
