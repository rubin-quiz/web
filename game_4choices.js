const quizDataByGenre = {
    "三大○○に含まれないもの": [
        {
            question: "三大栄養素に含まれないのはどれ？",
            choices: ["ビタミン", "タンパク質", "炭水化物", "脂質"],
            answer: 0
        },
        {
            question: "三大アレルゲンに含まれないのはどれ？",
            choices: ["そば", "鶏卵", "牛乳", "小麦"],
            answer: 0
        },
        {
            question: "日本三大祭りに含まれないのはどれ？",
            choices: ["七夕祭", "神田祭", "祇園祭", "天神祭"],
            answer: 0
        },
        {
            question: "世界三大珍味に含まれないのはどれ？",
            choices: ["フカヒレ", "フォアグラ", "トリュフ", "キャビア"],
            answer: 0
        },
        {
            question: "世界三大美女に含まれないのはどれ？",
            choices: ["マリリン・モンロー", "クレオパトラ", "楊貴妃", "小野小町"],
            answer: 0
        },
        {
        ...
        {
            question: "日本三大温泉に含まれないのはどれ？",
            choices: ["熱海温泉", "有馬温泉", "草津温泉", "下呂温泉"],
            answer: 0
        },
        {
            question: "日本三大珍味に含まれないのはどれ？",
            choices: ["納豆", "うに", "このわた", "からすみ"],
            answer: 0
        },
        {
            question: "日本三大茶に含まれないのはどれ？",
            choices: ["京都", "静岡", "宇治", "狭山"],
            answer: 0
        },
        {
            question: "世界三大紅茶に含まれないのはどれ？",
            choices: ["アッサム", "ダージリン", "ウバ", "キーマン"],
            answer: 0
        },
    ],
    "国の首都": [
...
// 正解フラグによる回答チェック
function checkAnswerByCorrectFlag(isCorrect, selectedButton) {
    // 既に回答済みの場合は処理しない
    ...
    gameState.userAnswers.push({
        ...
        choices: [...buttons].map(b => b.textContent), // 表示されている選択肢（シャッフル後）
